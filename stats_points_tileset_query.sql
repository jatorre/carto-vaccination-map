DROP TABLE IF EXISTS `cartobq.maps.covid19_vaccinated_stats_usa_tileset_temp1`;
CALL bqcarto.tiler.CREATE_POINT_AGGREGATION_TILESET(
R'''(
    SELECT * FROM `cartobq.maps.covid19_vaccinated_usa_blockgroups_100pct`
)''',
'`cartobq.maps.covid19_vaccinated_stats_usa_tileset_temp1`',
R'''
    {
    "zoom_min": 0,
    "zoom_max": 14,
...
SELECT * FROM `cartobq.maps.covid19_vaccinated_stats_usa_tileset_temp1`;
DROP TABLE IF EXISTS `cartobq.maps.covid19_vaccinated_stats_usa_tileset_temp1`;
...
--       geom
--       FROM `cartodb-gcp-backend-data-team.agraciano_tests.covid19_vaccinated_usa_blockgroups_100pct`
--   )''',
